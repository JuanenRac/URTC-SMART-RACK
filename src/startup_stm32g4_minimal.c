// =============================================================================
// URTC-SMART-RACK Firmware - Minimal Cortex-M4F startup: startup_stm32g4_minimal.c
// Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
// GPL-3.0 - see LICENSE
// =============================================================================
// Hand-written vector table + reset entry, standing in for ST's own
// CMSIS/HAL startup_stm32g4xx.s until a real PCB pins down the exact
// STM32G4 part number (see firmware_common.h and STM32G4_MINIMAL.ld's own
// header comments for why). Every G4 part shares the same 15 core Cortex-M4
// exception vectors (defined below, per ARM's architecture reference
// manual - not chip-specific); the peripheral interrupt slots after them
// ARE chip-specific and unknown without real hardware, so this reserves a
...
// substitute for ST's real startup_stm32g4xx.s once actual peripherals
// (F-RAM, CAN, thermal sensors) get wired up and their IRQs matter.
#include <stdint.h>
...
// until the real STM32G4 part (and therefore its real peripheral IRQ
// table) is known. See this file's own header comment.
